...
namespace TestTecnicals.Models {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuarioRow AddUsuarioRow(string name, string password, string email, int idRol) {
...
namespace TestTecnicals.Models.DataSet1TableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [USUARIO] WHERE (([id] = @Original_id))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [USUARIO] ([name], [password], [email], [idRol]) VALUES (@name, @pass" +
                "word, @email, @idRol)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [USUARIO] SET [name] = @name, [password] = @password, [email] = @email, [i" +
                "dRol] = @idRol WHERE (([id] = @Original_id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ProyectoWCFConnectionString"].ConnectionString;
        }
        ...
        public virtual int FillBy(DataSet1.UsuarioDataTable dataTable, int ID) {
        ...
        public virtual DataSet1.UsuarioDataTable GetDataBy(int ID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ID));
            DataSet1.UsuarioDataTable dataTable = new DataSet1.UsuarioDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual int Insert(string name, string password, string email, int idRol) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string password, string email, int idRol, int Original_id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
